...
/**
 * AgentBinaryPool entity - Agent commission pool management.
 */
@Entity
@Table(name = "eepip_agent_binary_pool")
public class AgentBinaryPool {
    ...
    public AgentBinaryPool() {
    }

    public AgentBinaryPool(String cycleMonth) {
